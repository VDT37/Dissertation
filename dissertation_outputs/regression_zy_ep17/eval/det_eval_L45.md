...
- Margin against the codec floor: +0.0775 mm/h (positive = the learned mean beats the round-tripped advection field, i.e. mu_r learned something that survives to pixels).
- Margin against RAW advection: +0.0757 mm/h. This is the pixel-space headline, and it is a different question from the gate.
- Codec round-trip penalty on advection alone: +0.0018 mm/h.
- Fraction of the achievable codec span (floor to ceiling) recovered: 0.307.

## Pixel error (lower is better)

| metric | regression_mean | codec_advection | codec_oracle | advection | persistence |
|---|---|---|---|---|---|
| MAE (mm/h) | 0.2177 | 0.2952 | 0.0428 | 0.2934 | 0.3622 |
| RMSE (mm/h) | 0.8730 | 1.0820 | 0.1941 | 1.0807 | 1.2511 |
| bias (mm/h) | -0.1052 | -0.0111 | +0.0071 | -0.0162 | -0.0012 |

## CSI by threshold (higher is better)

| mm/h | regression_mean | codec_advection | codec_oracle | advection | persistence |
|---|---|---|---|---|---|
| 0.5 | 0.4943 | 0.4599 | 0.9171 | 0.4589 | 0.3407 |
| 1 | 0.4233 | 0.3752 | 0.8872 | 0.3737 | 0.2669 |
| 2 | 0.3142 | 0.2550 | 0.8378 | 0.2530 | 0.1755 |
| 4 | 0.1971 | 0.1388 | 0.7769 | 0.1371 | 0.1039 |
| 8 | 0.0984 | 0.0576 | 0.7378 | 0.0566 | 0.0576 |

## Detection at 1 mm/h

| metric | regression_mean | codec_advection | codec_oracle | advection | persistence |
|---|---|---|---|---|---|
| POD | 0.5002 | 0.5414 | 0.9509 | 0.5360 | 0.4204 |
| FAR | 0.2665 | 0.4500 | 0.0702 | 0.4476 | 0.5777 |
| freq_bias | 0.6820 | 0.9844 | 1.0228 | 0.9702 | 0.9953 |

## FSS (neighbourhood scales, km)

| field, threshold | 1 km | 5 km | 11 km | 21 km | 51 km | 101 km |
|---|---|---|---|---|---|---|
| regression_mean, 1 mm/h | 0.602 | 0.703 | 0.767 | 0.823 | 0.892 | 0.927 |
| regression_mean, 8 mm/h | 0.221 | 0.323 | 0.396 | 0.495 | 0.641 | 0.731 |
...
|---|---|---|---|---|---|---|---|
| regression_mean | 0.784 | 0.225 | 0.143 | 0.092 | 0.090 | 0.092 | 0.091 |
