...
def main():
    ...
    ap.add_argument("--list-events", type=int, default=None, metavar="N",
                    help="open N frames spread through the record, score their "
                         "rain statistics and print convective and frontal "
                         "shortlists (0 = every timestamp); prints and exits")
    ...
    ap.add_argument("--style", default="pysteps", choices=["pysteps", "plain"],
                    help="pysteps draws coastlines and the log intensity scale; "
                         "plain is a raw array plot")
    ...
    if args.list_events is not None:
        ...
        print("\nConvective panels want a high p99.9 with a modest wet%, "
              "frontal panels a high wet% with a low p99.9.")
        return
