...
from train_vae_v1 import VAE as VAE1
from train_vae import (VAE as VAE2, NpzFields, domain_metrics, masked_l1,
                       CSI_T, TAIL_T)
...
def eval_ckpt(ckpt_path, VAECls, val_files, device, n_domain=512, n_l1=1024, workers=8):
    ...
    ds = NpzFields(val_files, mean, std)
    obs = np.arange(0, len(ds), 2)
